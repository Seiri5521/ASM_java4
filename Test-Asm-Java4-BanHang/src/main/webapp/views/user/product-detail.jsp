    ...
    <div class="container">
        <div class="left-column">
            <div class="thumbnails">
                <img src="<c:url value='/Template/User/sanpham/sp1.jpg'/>" alt="Thumbnail 1" onclick="changeImage('<c:url value='/Template/User/sanpham/sp1.jpg'/>')">
                <img src="<c:url value='/Template/User/sanpham/sp2.jpg'/>" alt="Thumbnail 2" onclick="changeImage('<c:url value='/Template/User/sanpham/sp2.jpg'/>')">
                <img src="<c:url value='/Template/User/sanpham/sp3.jpg'/>" alt="Thumbnail 3" onclick="changeImage('<c:url value='/Template/User/sanpham/sp3.jpg'/>')">
                <img src="<c:url value='/Template/User/sanpham/sp4.jpg'/>" alt="Thumbnail 4" onclick="changeImage('<c:url value='/Template/User/sanpham/sp4.jpg'/>')">
            </div>
        </div>
        <div class="main-image">
            <img id="mainImage" src="<c:url value='/Template/User/sanpham/sp1.jpg'/>" alt="Main Image">
        </div>
        <div class="container">
                ...
                <div class="product-item">
                    ...
                    <div class="colors">
                        ...
                        <div style="display: flex; gap: 5px; margin-top: 5px;">
                            <div style="background-color: #000; width: 20px; height: 20px; border-radius: 50%; cursor: pointer;" class="color-option selected"></div>
                            <div style="background-color: #fff; width: 20px; height: 20px; border-radius: 50%; cursor: pointer;" class="color-option"></div>
                            <div style="background-color: #ccc; width: 20px; height: 20px; border-radius: 50%; cursor: pointer;" class="color-option"></div>
                            <div style="background-color: #000080; width: 20px; height: 20px; border-radius: 50%; cursor: pointer;" class="color-option"></div>
                            <div style="background-color: #ff69b4; width: 20px; height: 20px; border-radius: 50%; cursor: pointer;" class="color-option"></div>
                        </div>
                    </div>
                    ...
                    <div class="sizes" style="margin-top: 10px;">
                        ...
                        <div style="display: flex; gap: 5px; margin-top: 5px;">
                            <div class="size-option selected" style="padding: 5px 10px; border: 1px solid #000; cursor: pointer;">S</div>
                            <div class="size-option" style="padding: 5px 10px; border: 1px solid #000; cursor: pointer;">M</div>
                            <div class="size-option" style="padding: 5px 10px; border: 1px solid #000; cursor: pointer;">L</div>
                            <div class="size-option" style="padding: 5px 10px; border: 1px solid #000; cursor: pointer;">XL</div>
                            <div class="size-option" style="padding: 5px 10px; border: 1px solid #000; cursor: pointer;">XXL</div>
                        </div>
                    </div>
                    ...
                    <form action="cart.jsp" method="post" style="margin-top: 10px;">
                        ...
                        <input type="hidden" name="quantity" value="1"> <!-- Có thể thay đổi nếu cần -->
                    ...
                    <div class="tabs">
                        <button class="tab-link" onclick="showTab(event, 'details')">Chi tiết</button>
                        <button class="tab-link" onclick="showTab(event, 'care')">Chất liệu / Cách chăm sóc</button>
                    </div>
                    <div id="details" class="tab-content">
                        <h2>Chi tiết</h2>
                        <p>Váy dạ hội cao cấp thiết kế sang trọng, quý phái, phù hợp cho các buổi tiệc tối, dạ hội hoặc các sự kiện quan trọng. Chất liệu mềm mại, thoải mái, mang lại sự tự tin và quyến rũ cho người mặc.</p>
                        <ul>
                    ...
                    <div id="care" class="tab-content">
                        ...
                        <p><strong>Chất liệu:</strong> Lụa cao cấp kết hợp với ren tinh tế, tạo nên sự mềm mại và thoải mái khi mặc.</p>
